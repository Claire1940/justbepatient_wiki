...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Terms of Service - Just Be Patient Wiki',
    description: 'Read the Terms of Service for Just Be Patient Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our psychological horror visual novel resource platform.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Terms of Service - Just Be Patient Wiki',
      description: 'Terms and conditions for using Just Be Patient Wiki.',
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Just Be Patient Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Just Be Patient Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Just Be Patient Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Just Be Patient Wiki is an unofficial, community-driven fan website that provides information, guides, and
              resources related to the psychological horror visual novel "Just Be Patient" developed by Hexed Honey and
              available on itch.io. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Endings and story route guides</li>
              <li>Choice and consequence walkthroughs</li>
              <li>Character information and analysis</li>
              <li>Content warnings and trigger information</li>
              <li>Gameplay tips and strategies</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Just Be Patient Wiki is NOT affiliated with, endorsed by, or associated with
              Hexed Honey, itch.io, or the official developers of Just Be Patient. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Just Be Patient Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Hexed Honey and/or the respective owners of Just Be Patient. We use such
            ...
            <ul>
              ...
              <li><strong>Mature Content:</strong> Just Be Patient is a psychological horror visual novel intended for mature audiences. Our content may include discussions of disturbing themes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, JUST BE PATIENT WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including itch.io, YouTube, TikTok, social media platforms,
            ...
            <p>
              ...
              you and Just Be Patient Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@justbepatient.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@justbepatient.wiki</a>
            </p>
            <p>
