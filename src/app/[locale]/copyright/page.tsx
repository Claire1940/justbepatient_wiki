...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Just Be Patient Wiki',
    description: 'Copyright and intellectual property information for Just Be Patient Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Just Be Patient Wiki',
      description: 'Copyright and intellectual property information for Just Be Patient Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Just Be Patient Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Just Be Patient Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Just Be Patient Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Hexed Honey</strong> - Developer of Just Be Patient</li>
              <li><strong>itch.io</strong> - Distribution platform hosting the game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li>Character names and story content</li>
              <li>In-game music and audio assets</li>
            </ul>
            <p>
              ...are the intellectual property of Hexed Honey and their respective owners. We use such content under
              the principles of fair use for informational, educational, and non-commercial purposes only.
            </p>
            ...
            <ul>
              ...
              <li><strong>Educational:</strong> We help players understand the game's story, endings, and choices</li>
            ...
            <ul>
              <li><strong>Just Be Patient</strong> - Trademark of Hexed Honey</li>
              <li><strong>itch.io</strong> - Trademark of itch Corp</li>
              <li><strong>Just Be Patient Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Just Be Patient Wiki.
            </p>
            ...
            <p>
              ...
              Just Be Patient Wiki<br />
              Email: <a href="mailto:dmca@justbepatient.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@justbepatient.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Just Be Patient Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Just Be Patient Wiki (justbepatient.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@justbepatient.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@justbepatient.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@justbepatient.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@justbepatient.wiki</a>
            </p>
            <p>
